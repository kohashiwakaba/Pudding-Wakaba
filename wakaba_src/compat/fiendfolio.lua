...
function wakaba:GameStart_FiendFolioCompat()
	if FiendFolio and not ffReplaced then
		...
		table.insert(FiendFolio.ReferenceItems.Passives, {ID = wakaba.Enums.Collectibles.MAGMA_BLADE, Reference = "Mega Man X"})
		...
		table.insert(FiendFolio.ReferenceItems.Passives, {ID = wakaba.Enums.Collectibles.CLENSING_FOAM, Reference = "Bloons TD"})
		...
		table.insert(FiendFolio.ReferenceItems.Passives, {ID = wakaba.Enums.Collectibles.CRISIS_BOOST, Reference = "Paper Mario"})
		...
		table.insert(FiendFolio.ReferenceItems.Passives, {ID = wakaba.Enums.Collectibles.TRIAL_STEW, Reference = "Paper Mario"})
