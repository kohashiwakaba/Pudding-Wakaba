...
wakaba.UnlockTables = {
	...
	[wakaba.Enums.Players.RIRA] = {
		Heart 		= {"blackbeanmochi", "collectible", 		wakaba.Enums.Collectibles.BLACK_BEAN_MOCHI,		function() wakaba:TryPlayAchievementPaper("fireflylighter", "Boss") end},
		Isaac 		= {"nerfgun", "collectible",	wakaba.Enums.Collectibles.NERF_GUN,		function() wakaba:TryPlayAchievementPaper("sweetscatalog", "Boss") end},
		BlueBaby 	= {"sakuramontblanc", "collectible",	wakaba.Enums.Collectibles.SAKURA_MONT_BLANC,		function() wakaba:TryPlayAchievementPaper("doubleinvader", "Boss") end},
		Satan 		= {"riraswimsuit", "collectible",	wakaba.Enums.Collectibles.RIRAS_SWIMSUIT,		function() wakaba:TryPlayAchievementPaper("antibalance", "Boss") end},
		Lamb		= {"chewyrollycake", "collectible",	wakaba.Enums.Collectibles.CHEWY_ROLLY_CAKE,				function() wakaba:TryPlayAchievementPaper("venomincantation", "Boss") end},
		BossRush	= {"caramellapancake", "collectible",	wakaba.Enums.Collectibles.CARAMELLA_PANCAKE,				function() wakaba:TryPlayAchievementPaper("bunnyparfait", "Boss") end},
		Hush		= {"rirauniform", "collectible",	wakaba.Enums.Collectibles.RIRAS_UNIFORM,		function() wakaba:TryPlayAchievementPaper("richeruniform", "Boss") end},
		Delirium	= {"rirabandage", "collectible",	wakaba.Enums.Collectibles.RIRAS_BANDAGE,				function() wakaba:TryPlayAchievementPaper("prestigepass", "Boss") end},
		MegaSatan	= {"rirabento", "collectible",		wakaba.Enums.Collectibles.RIRAS_BENTO,			function() wakaba:TryPlayAchievementPaper("3dprinter", "MegaSatan") end},
		Mother		= {"sakuracapsule", "collectible",	wakaba.Enums.Collectibles.SAKURA_CAPSULE,			function() wakaba:TryPlayAchievementPaper("cunningpaper", "Boss") end},
		Beast		= {"maidduet", "collectible",	wakaba.Enums.Collectibles.MAID_DUET,		function() wakaba:TryPlayAchievementPaper("selfburning", "Beast") end},
		Greed		= {"rabbitpillow", "trinket",	wakaba.Enums.Trinkets.RABBIT_PILLOW,	function() wakaba:TryPlayAchievementPaper("clensingfoam", "Boss") end},
		Greedier	= {"lilrira", "collectible",		wakaba.Enums.Collectibles.LIL_RIRA,			function() wakaba:TryPlayAchievementPaper("lilricher", "Boss") end},

		All 		= {"chimaki", "collectible",	wakaba.Enums.Collectibles.CHIMAKI,	function() wakaba:TryPlayAchievementPaper("rabbitribbon", "Boss") end},
	},
	[-999] = {
