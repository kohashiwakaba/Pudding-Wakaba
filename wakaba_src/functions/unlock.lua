...
wakaba.UnlockTables = {
	...
	[wakaba.Enums.Players.RICHER] = {
		...
		BossRush	= {"caramellapancake", "null",	wakaba.Enums.Cards.CARD_DREAM_CARD,				function() CCO.AchievementDisplayAPI.PlayAchievement("gfx/ui/achievement/achievement_blank.png") end},
