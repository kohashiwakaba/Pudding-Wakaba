...
wakaba.descriptions[desclang].doubledreams = {
	...
	BatteryBum = "Battery Bum Pool",
	MomChest = "Mom's Chest Pool",
	GreedTreasure = "Greed Treasure Pool",
	GreedBoss = "Greed Boss Pool",
	GreedShop = "Greed Shop Pool",
	GreedDevil = "Greed Devil Pool",
	GreedAngel = "Greed Angel Pool",
	GreedCurse = "Greed Curse Pool",
	GreedSecret = "Greed Secret Pool",
	CraneGame = "Crane Game Pool",
	UltraSecret = "Ultra Secret Pool",
	BombBum = "Bomb Bum Pool",
	Planetarium = "Planetarium Pool",
	OldChest = "Old Chest Pool",
	BabyShop = "Baby Shop Pool",
	WoodenChest = "Wooden Chest Pool",
	RottenBeggar = "Rotten Beggar Pool",
}
