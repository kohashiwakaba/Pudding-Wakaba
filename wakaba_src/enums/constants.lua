...
wakaba.Enums.Constants = {
	...
	LIL_RICHER_BASIC_DMG = 2,
	LIL_RICHER_BASIC_COOLDOWN = 30,
...
wakaba.VanillaPoolDatas = {
	...
	[0] = {Icon = "{{TreasureRoom}}", StringID = "Treasure", DoubleDreams = "doubledreams"},
	[1] = {Icon = "{{Shop}}", StringID = "Shop", DoubleDreams = "doubledreams"},
	[2] = {Icon = "{{BossRoom}}", StringID = "Boss", DoubleDreams = "doubledreams"},
	[3] = {Icon = "{{DevilRoom}}", StringID = "Devil", DoubleDreams = "doubledreams"},
	[4] = {Icon = "{{AngelRoom}}", StringID = "Angel", DoubleDreams = "doubledreams"},
	[5] = {Icon = "{{SecretRoom}}", StringID = "Secret", DoubleDreams = "doubledreams"},
	[6] = {Icon = "{{Library}}", StringID = "Library", DoubleDreams = "doubledreams"},
	[7] = {Icon = "{{Beggar}}{{MiniBossRoom}}", StringID = "ShellGame", DoubleDreams = "doubledreams"},
	[8] = {Icon = "{{GoldenChest}}", StringID = "GoldenChest", DoubleDreams = "doubledreams"},
	[9] = {Icon = "{{RedChest}}", StringID = "RedChest", DoubleDreams = "doubledreams"},
	...
	[12] = {Icon = "{{CurseRoom}}", StringID = "Curse", DoubleDreams = "doubledreams"},
	...
	[23] = {Icon = "{{CraneGame}}", StringID = "CraneGame", DoubleDreams = "doubledreams"},
	[24] = {Icon = "{{UltraSecretRoom}}", StringID = "UltraSecret", DoubleDreams = "doubledreams"},
	[25] = {Icon = "{{BombBeggar}}", StringID = "BombBum", DoubleDreams = "doubledreams"},
	[26] = {Icon = "{{Planetarium}}", StringID = "Planetarium", DoubleDreams = "doubledreams"},
	[27] = {Icon = "{{DirtyChest}}", StringID = "OldChest", DoubleDreams = "doubledreams"},
	[28] = {Icon = "{{Shop}}", StringID = "BabyShop", DoubleDreams = "doubledreams"},
