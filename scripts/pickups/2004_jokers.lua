wakaba.CARD_BLACK_JOKER = Isaac.GetCardIdByName("Black Joker")
wakaba.CARD_WHITE_JOKER = Isaac.GetCardIdByName("White Joker")
wakaba.CARD_COLOR_JOKER = Isaac.GetCardIdByName("Color Joker")
