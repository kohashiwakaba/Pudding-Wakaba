wakaba.CARD_DREAM_CARD = Isaac.GetCardIdByName("Wakaba's Dream Card")
...
wakaba:AddCallback(ModCallbacks.MC_USE_CARD, wakaba.onUseCard2005, wakaba.CARD_DREAM_CARD)
...
function wakaba:onGetCard2005(rng, currentCard, playing, runes, onlyRunes)
	...
	if not onlyRunes and currentCard == wakaba.CARD_DREAM_CARD then
