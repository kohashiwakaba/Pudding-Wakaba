if Encyclopedia then
	...
	local Wiki = {
		...
		TSUKASA = {
			...
			--[[ { -- Unlockables
					...
					{str = "x Question Block : Defeat Ultra Greedier as Tsukasa"},
					{str = "- New Year's Eve Bomb : Defeat Delirium as Tsukasa"},
					{str = "x Phantom Cloak : Defeat Mother as Tsukasa"},
					{str = "x Hydra : Defeat The Beast as Tsukasa"},
		...
		TSUKASA_B = {
			...
			{ -- Traits
					...
					{str = "Tsukasa can only use Flash Shift 3 times. After using 3 times, Tsukasa needs to wait 4 seconds to make available again."},
					{str = "Using Flash Shift will grant Tsukasa 20 invincibility frames."},
			},
			{ -- Birthright
					{str = "Birthright", fsize = 2, clr = 3, halign = 0},
					{str = "Increases Invincibilty frames for 1, 2 frames in Normal/Hard mode."},
					{str = "Reduces minimum required time to get regenerated."},
			},
			{ -- Notes
					{str = "Notes", fsize = 2, clr = 3, halign = 0},
			...
			--[[ { -- Unlockables
					{str = "Unlockables", fsize = 2, clr = 3, halign = 0},
					{str = "x Isaac Cartridge : Defeat Isaac, Satan, ???, The Lamb as Tainted Tsukasa"},
					{str = "-- Afterbirth/Repentance Cartridge are also unlocked with Isaac Cartridge"},
					{str = "x Maple Syrup : Defeat Mega Satan as Tainted Tsukasa"},
					{str = "x Soul of Tsukasa : Defeat Boss Rush, Hush as Tainted Tsukasa"},
					{str = "x Return Card : Defeat Ultra Greedier as Tainted Tsukasa"},
					{str = "- Flash Shift : Defeat Delirium as Tainted Tsukasa"},
					{str = "x Siren's Badge : Defeat Mother as Tainted Tsukasa"},
					{str = "x Elixir of life : Defeat The Beast as Tainted Tsukasa"},
			}, ]]
			{ -- Trivia
					{str = "Trivia", fsize = 2, clr = 3, halign = 0},
		...
		COLLECTIBLE_WAKABAS_NEMESIS = {
			{ -- Effects
				...
				{str = "Guarentees the Devil/Angel Room encountered to be an Devil Room."},
				{str = "- Angel Rooms will no longer appear unless Isaac has Duality, Wakaba's Blessing, or White Joker."},
		...
		COLLECTIBLE_MYSTERIOUS_GAME_CD = {
			{ -- Effect
				{str = "Effect", fsize = 2, clr = 3, halign = 0},
				{str = "Grants one full Red Heart container."},
				{str = "Heals 1 additional heart of health."},
		...
		CARD_DONATION_CARD = {
			{ -- Effect
				{str = "Effect", fsize = 2, clr = 3, halign = 0},
				{str = "Spawns/unjams a donation machine."},
			},
			{ -- Trivia
				{str = "Trivia", fsize = 2, clr = 3, halign = 0},
				{str = "This card was originally from Donation Card Mod by GateGuy, which also gave a penny for infinite donation for the current room."},
				{str = "- VIP Donation Card will do same as original Donation Card."},
			},
		},
		CARD_VIP_DONATION_CARD = {
			{ -- Effect
				{str = "Effect", fsize = 2, clr = 3, halign = 0},
				{str = "Spawns/unjams a donation machine."},
				{str = "Spawns a penny which allows free coin donations for the current room."},
			},
			{ -- Trivia
				{str = "Trivia", fsize = 2, clr = 3, halign = 0},
				{str = "This card was originally from Donation Card Mod by GateGuy."},
				{str = "- Original mod works partially as infinite donation no longer works in repentance. this is due to change of saving system."},
			},
		},
		CARD_CRANE_CARD = {
			{ -- Effect
		...
		COLLECTIBLE_GRIMREAPER_DEFENDER = {
			{ -- Effects
				{str = "Effects", fsize = 2, clr = 3, halign = 0},
			...
			{ -- Synergies
				...
				{str = "Taking damage from any sources does not count as damage taken for Damocles, and will not give it the chance to fall."},
				{str = "Tainted Eden", clr = 3, halign = 0},
				{str = "Taking any damage will not occur reroll effect as long as the effect of Grimreaper Defender is active."},
			},
		},

		COLLECTIBLE_MICRO_DOPPELGANGER = {
			{ -- Effects
				{str = "Effects", fsize = 2, clr = 3, halign = 0},
		...
		COLLECTIBLE_BOOK_OF_THE_FALLEN = {
			{ -- Effect
				{str = "Effect", fsize = 2, clr = 3, halign = 0},
				{str = "Grants an extra life."},
		...
		COLLECTIBLE_ELIXIR_OF_LIFE = {
			...
			{ -- Trivia
				...
				{str = "- In 'Tonikawa', which was heavily influenced by this tale, The emperor's man, Iwasaka, ignored his orders and gave elixir to his daughter, Tsukasa."},
			},
		},
		COLLECTIBLE_MURASAME = {
			{ -- Effect
				{str = "Effect", fsize = 2, clr = 3, halign = 0},
    ...
    Description = "The Clover",
		WikiDesc = Wiki.WAKABA,
    ID = wakaba.PLAYER_WAKABA,
		Sprite = Encyclopedia.RegisterSprite(wakaba.modpath .. "content/gfx/characterportraits.anm2", "Wakaba",0),--, nil, Item.GfxFileName)
    ...
    Description = "The Fury",
		WikiDesc = Wiki.WAKABA_B,
    ID = wakaba.PLAYER_WAKABA_B,
		Sprite = Encyclopedia.RegisterSprite(wakaba.modpath .. "content/gfx/characterportraitsalt.anm2", "WakabaB",0),--, nil, Item.GfxFileName)
   	CompletionTrackerFuncs = { -- You can skip this one if your mod doesn't have custom unlocks.
      function()
				local UnlocksTab = {
    ...
    Description = "The Bookmark",
		WikiDesc = Wiki.SHIORI,
    ID = wakaba.PLAYER_SHIORI,
		Sprite = Encyclopedia.RegisterSprite(wakaba.modpath .. "content/gfx/characterportraits.anm2", "Shiori",0),--, nil, Item.GfxFileName)
		CompletionTrackerFuncs = { -- You can skip this one if your mod doesn't have custom unlocks.
			function()
				local UnlocksTab = {
					...
					Hush = {Unlock = (wakaba.state.unlock.bookofgatling >= 1), Hard = (wakaba.state.unlock.bookofgatling == 2)},
					...
					Mother = {Unlock = (wakaba.state.unlock.bookoftheking >= 1), Hard = (wakaba.state.unlock.bookoftheking == 2)},
    ...
    Description = "The Minerva",
		WikiDesc = Wiki.SHIORI_B,
    ID = wakaba.PLAYER_SHIORI_B,
		Sprite = Encyclopedia.RegisterSprite(wakaba.modpath .. "content/gfx/characterportraitsalt.anm2", "ShioriB",0),--, nil, Item.GfxFileName)
   	CompletionTrackerFuncs = { -- You can skip this one if your mod doesn't have custom unlocks.
      function()
				local UnlocksTab = {
					...
					MegaSatan = {Unlock = (wakaba.state.unlock.librarycard >= 1), Hard = (wakaba.state.unlock.librarycard == 2)},
    ...
    Description = "The Entertainer",
		WikiDesc = Wiki.TSUKASA,
    ID = wakaba.PLAYER_TSUKASA,
		Sprite = Encyclopedia.RegisterSprite(wakaba.modpath .. "content/gfx/characterportraits.anm2", "Tsukasa",0),--, nil, Item.GfxFileName)
		CompletionTrackerFuncs = { -- You can skip this one if your mod doesn't have custom unlocks.
			function()
				local UnlocksTab = {
					...
					BlueBaby = {Unlock = (wakaba.state.unlock.totalcorruption >= 1), Hard = (wakaba.state.unlock.totalcorruption == 2)},
					...
					Hush = {Unlock = (wakaba.state.unlock.rangesystem >= 1), Hard = (wakaba.state.unlock.rangesystem == 2)},
					MegaSatan = {Unlock = (wakaba.state.unlock.beam >= 1), Hard = (wakaba.state.unlock.beam == 2)},
					...
					Beast = {Unlock = (wakaba.state.unlock.hydra >= 1), Hard = (wakaba.state.unlock.hydra == 2)},
    ...
    Description = "The Phoenix",
		WikiDesc = Wiki.TSUKASA_B,
    ID = wakaba.PLAYER_TSUKASA_B,
      ...
      function()
				local UnlocksTab = {
					...
					MegaSatan = {Unlock = (wakaba.state.unlock.maplesyrup >= 1), Hard = (wakaba.state.unlock.maplesyrup == 2)},
					...
					GreedMode = {Unlock = (wakaba.state.unlock.returncard >= 1), Hard = (wakaba.state.unlock.returncard == 2)},
				}
        return UnlocksTab
      end
    },
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if not wakaba.state.unlock.blessing and not wakaba.state.hasbless then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.nemesis < 1 and not wakaba.state.hasnemesis then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if not (wakaba.state.hasbless and wakaba.state.hasnemesis) then
				self.Desc = "???"
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if not wakaba.state.unlock.bookofshiori and not wakaba.hasshiori then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			...
			if wakaba.state.unlock.eatheart < 1 and not hastaintedwakaba then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.bookofconquest < 1 and not wakaba.hastaintedshiori then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.minervaaura < 1 and not wakaba.hastaintedshiori then
	...
	Encyclopedia.AddItem({
		...
		--[[ UnlockFunc = function(self)
			...
			if not haslunarstone then
				self.Desc = "Only available for Tsukasa"
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			...
			if not haselixir then
				self.Desc = "Only available for Tainted Tsukasa"
	...
	Encyclopedia.AddItem({
		...
		ActiveCharge = 6,
		UnlockFunc = function(self)
			if not wakaba.state.unlock.bookofforgotten then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.dcupicecream < 1 then
	...
	Encyclopedia.AddItem({
		...
		--[[UnlockFunc = function(self)
			if not wakaba.state.unlock.dcupicecream then
				self.Desc = "-"
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.pendant < 1 then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.secretcard < 1 then
	...
	Encyclopedia.AddCard({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.donationcard < 1 then
	...
	Encyclopedia.AddSoul({
		...
		UnlockFunc = function(self)
			if not wakaba.state.unlock.wakabasoul then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.revengefruit < 1 then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.counter < 1 then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.returnpostage < 1 then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.bookoffocus < 1 and not wakaba.hasshiori then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.deckofrunes < 1 and not wakaba.hasshiori then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.grimreaperdefender < 1 and not wakaba.hasshiori then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.bookoffallen < 1 then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.bookofgatling < 1 and not wakaba.hasshiori then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.bookofsilence < 1 and not wakaba.hasshiori then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.bookoftheking < 1 then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.bookofthegod < 1 then
	...
	Encyclopedia.AddItem({
		...
		UnlockFunc = function(self)
			if wakaba.state.unlock.newyearbomb < 1 then
