    ...
    EID:addColor("ColorBookofConquest", nil, function(_)
	  ...
	  local function BetterVoidingCallback(descObj)
		...
		function wakaba:UpdateWakabaDescriptions()
			...
			EID:addIcon("MomsHeart", "Destination", 1, 8, 12, -1, -1, wakaba.TargetIcons)
			EID:addIcon("Isaac", "Destination", 3, 8, 12, -1, -1, wakaba.TargetIcons)
			EID:addIcon("Satan", "Destination", 2, 8, 12, -1, -1, wakaba.TargetIcons)
			EID:addIcon("BlueBaby", "Destination", 5, 8, 12, -1, -1, wakaba.TargetIcons)
			EID:addIcon("TheLamb", "Destination", 4, 8, 12, -1, -1, wakaba.TargetIcons)
			EID:addIcon("MegaSatan", "Destination", 6, 8, 12, -1, -1, wakaba.TargetIcons)
			EID:addIcon("BossRush", "Destination", 7, 8, 12, 1, -1, wakaba.TargetIcons)
			EID:addIcon("Hush", "Destination", 8, 8, 12, -1, -1, wakaba.TargetIcons)
			EID:addIcon("Delirium", "Destination", 9, 8, 12, -1, -1, wakaba.TargetIcons)
			EID:addIcon("Mother", "Destination", 11, 8, 12, -1, -1, wakaba.TargetIcons)
			EID:addIcon("Beast", "Destination", 12, 8, 12, -1, -1, wakaba.TargetIcons)
			EID:addIcon("Greed", "Destination", 10, 8, 12, -1, -1, wakaba.TargetIcons)
			EID:addIcon("Completion", "Destination", 13, 8, 12, -1, -1, wakaba.TargetIcons)
	  ...
	  --EID:addDescriptionModifier("Wakaba's Horse Pills", WakabaPillCondition, WakabaPillCallback)
		...
		function wakaba:CheckWakabaAchievementString()
			...
			str = str .. getmarkup(wakaba.state.unlock.donationcard) .. "{{BossRush}} "
			...
			str = str .. getmarkup(wakaba.state.unlock.wakabasoul1) .. "{{BossRush}} "
			...
			str = str .. getmarkup(wakaba.state.unlock.blackjoker) .. "{{Greed}} "
			...
			str = str .. getmarkup(wakaba.state.unlock.unknownbookmark) .. "{{BossRush}} "
			...
			str = str .. getmarkup(wakaba.state.unlock.determinationribbon) .. "{{Greed}} "
			str = str .. getmarkup(wakaba.state.unlock.bookoftheking) .. "{{Mother}} "
			str = str .. getmarkup(wakaba.state.unlock.bookofthegod) .. "{{Beast}} "
			str = str .. getboolup(wakaba.state.unlock.bookofshiori) .. "{{Completion}} "
			...
			str = str .. getmarkup(wakaba.state.unlock.shiorisoul1) .. "{{BossRush}} "
			...
			str = str .. getmarkup(wakaba.state.unlock.queenofspades) .. "{{Greed}} "
			...
			str = str .. getmarkup(wakaba.state.unlock.concentration) .. "{{BossRush}} "
			...
			str = str .. getmarkup(wakaba.state.unlock.questionblock) .. "{{Greed}} "
			str = str .. getmarkup(wakaba.state.unlock.phantomcloak) .. "{{Mother}} "
			str = str .. getmarkup(wakaba.state.unlock.hydra) .. "{{Beast}} "
			str = str .. getboolup(wakaba.state.unlock.lunarstone) .. "{{Completion}} "
			...
			str = str .. getmarkup(wakaba.state.unlock.tsukasasoul1) .. "{{BossRush}} "
