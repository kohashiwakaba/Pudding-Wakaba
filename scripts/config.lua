...
--[[ 
	...
	MCM.AddSetting(
		...
		"Unlock",
		{
			Type = ModConfigMenu.OptionType.NUMBER,
			CurrentSetting = function()
				return wakaba.state.unlock.bookofgatling
			end,
			Minimum = 0,
			Maximum = 2,
			Display = function()
				return "Book of Trauma : " .. unlockstats[1+wakaba.state.unlock.bookofgatling]
			end,
			Info = {
	...
	MCM.AddSetting(
		...
		"Unlock",
		{
			Type = ModConfigMenu.OptionType.NUMBER,
			CurrentSetting = function()
				return wakaba.state.unlock.bookoftheking
			end,
			Minimum = 0,
			Maximum = 2,
			Display = function()
				return "Vintage Threat : " .. unlockstats[1+wakaba.state.unlock.bookoftheking]
			end,
			Info = {
	...
	MCM.AddSetting(
		...
		"Unlock",
		{
			Type = ModConfigMenu.OptionType.NUMBER,
			CurrentSetting = function()
				return wakaba.state.unlock.librarycard
			end,
			Minimum = 0,
			Maximum = 2,
			Display = function()
				return "Another Fortune Machine : " .. unlockstats[1+wakaba.state.unlock.librarycard]
			end,
			Info = {
