wakaba.COLLECTIBLE_GRIMREAPER_DEFENDER = Isaac.GetItemIdByName("Grimreaper Defender")
...
wakaba:AddCallback(ModCallbacks.MC_USE_ITEM, wakaba.ItemUse_GrimreaperDefender, wakaba.COLLECTIBLE_GRIMREAPER_DEFENDER)
